 ...
 * All rights reserved
 */
((e,t)=>{function n(e,t=20){let n;return function(...o){clearTimeout(n),n=setTimeout(()=>e.apply(this,o),t)}}const o=new Promise(e=>{if("loading"!==t.readyState)return e();t.addEventListener("DOMContentLoaded",()=>e())}),a="6LfT7JoUAAAAAOJeXkJp-_YhnKEvnz3DhEM-ni2n",r=12e4,c=400,s=[new RegExp("\\b(?:"+["stackoverflow\\.com","stackoverflow","stack\\s+overflow","on\\s+stack","deleted","my\\s+(?:answer|question|comment|post|response)s?","reputations?","upvotes","reconsider\\s+your\\s+actions","review\\s+(?:my\\s+)?ban","who\\s+do\\s+you\\s+think\\s+you\\s+are"].join("|")+")\\b","ig"),new RegExp("\\b(?:"+["on\\s+SO"].join("|")+")\\b","g")],i=[new RegExp("\\b(?:"+["for\\s+freelance\\s+work","(?:you\\s+)?are\\s+available","be\\s+available","(?:your\\s+)?hourly\\s+rate","interview\\s+you","python\\s+training","partnering\\s+with"].join("|")+")\\b","ig")],l=2,u=(e,t)=>t.reduce((t,n)=>t+(e.match(n)||[]).length,0),v=(o,v)=>{const p=o.querySelector("#captchaResponse"),g=o.querySelector('button[type="submit"]'),d=o.querySelector("#contact_name"),f=o.querySelector("#contact_email"),m=o.querySelector("#contact_message"),y=o.querySelector("#stackoverflow_feedback"),h=o.querySelector("#contact_soscore");let b=!1;const _=e=>{grecaptcha.ready(()=>{grecaptcha.execute(a,{action:e}).then(e=>{p.value=e})})};_("contactform_load"),e.setInterval(_,.9*r,"contactform_token_refresh"),m.addEventListener("input",n(()=>{const e=m.value,t=u(e,s)-u(e,i);h.value=t.toString(),t<l?(b&&(y.classList.remove("show"),v("event","so_feedback_hidden",{event_category:"contact",event_label:[d.value,f.value,e].join("|"),value:t})),b=!1):(b||(y.classList.add("show"),v("event","so_feedback_shown",{event_category:"contact",event_label:[d.value,f.value,e].join("|"),value:t})),b=!0)},c)),o.addEventListener("input",e=>{e.target.matches("input,textarea")&&g.toggleAttribute("disabled",!o.checkValidity())});const k=e=>{const t=e.target,n=parseInt(t.getAttribute("maxlength"),10);if(isNaN(n))return void t.removeEventListener("input",k);const o=t.value.length,a=`label[for="${t.id}"].message-count`;let r=t.parentElement.querySelector(a);if(o<n/2)r&&r.remove();else{if(null===r)t.insertAdjacentHTML("beforebegin",`<label class="message-count" for="${t.id}" aria-hidden="true">\n            <span class="counter">${o}</span>/<span class="maxlength">${n}</span>\n          </label>\n        `),r=t.previousElementSibling;else{r.querySelector(".counter").innerText=o.toString()}r.classList.toggle("near-limit",o>.9*n)}};o.querySelectorAll("input[maxlength],textarea[maxlength]").forEach(e=>e.addEventListener("input",k)),o.addEventListener("submit",n=>{n.preventDefault();const a=o.action,r=f.value||"<no email set>",c=o.dataset.success,s=o.dataset.error,i=t.querySelector(o.dataset.errorText),l=e.jQuery.magnificPopup.instance;v("event","submit",{event_category:"contact",event_label:r,value:parseInt(h.value,10)});const u=(t,n="fail")=>{l.close();let o=!1;v("event",n,{event_category:"contact",event_label:r,description:`Contact form submission error: ${t}`,fatal:!1,event_callback:()=>{o=!0}});const a=()=>{if(!o)return o=!0,void e.setTimeout(a,100);_("contactform_error_retry")};i.innerHTML=t,l.open({type:"inline",items:{src:s},callbacks:{close:a}},0)},p=e=>{const t=e.message.map(e=>`<p>${e}</p>`).join("\n");return`<h4>${e.title}</h4><p>(${e.code}) ${e.status}</p>${t}`};fetch(a,{method:"POST",headers:{Accept:"application/json"},body:new FormData(o)}).then(e=>{if(e.ok)return e.json();let t=!1;return e.json().then(e=>{throw t=!0,new Error(p(e))})["catch"](n=>{if(t)throw n;throw new Error(`Unexpected form server response: ${e.status} ${e.statusText}`)})}).then(n=>{if(l.close(),200!==n.code)return void u(p(n));let o=!1;v("event","successful",{event_category:"contact",event_label:r,value:parseInt(h.value,10),event_callback:()=>{o=!0}});const a=()=>{if(!o)return o=!0,void e.setTimeout(a,100);t.location="/"};l.open({type:"inline",items:{src:c},callbacks:{close:a}},0)})["catch"](e=>{e instanceof DOMException||(e instanceof TypeError?u("Failed to contact the form server (network error)","exception"):e instanceof SyntaxError?u("Failed to contact the form server (invalid response)","exception"):u(e.message,"exception"))})})};o.then(()=>{const n=e.gtag||((e,t,n)=>{console.log("gtag()",e,t,n),"event"===e&&"event_callback"in n&&n.event_callback()}),o=e.onerror;e.onerror=function(e,t,a,r,c){"undefined"!=typeof StackTrace&&StackTrace.fromError(c).then(o=>{const c={msg:e,file:t,line:a,col:r,stack:o};n("event","exception",{description:JSON.stringify(c),fatal:!0})})["catch"](()=>{try{n("event","exception",{description:`Failure to create stacktrace; ${t}:${a}:${r} ${e} (${c})`,fatal:!0})}catch(o){console.log("Giving up on all error handling, bailing out",o,[e,t,a,r,c])}}),"function"==typeof o&&o(e,t,a,r,c)};const a=t.querySelector(".contactForm");null!==a&&v(a,n);const r=t.location.hostname;Array.from(t.querySelectorAll("a[href]")).filter(e=>e.hostname!==r).forEach(o=>o.addEventListener("click",o=>{const a=o.target.closest("a[href]").href,r="_blank"===o.target.target||o.metaKey||o.ctrlKey||o.shiftKey||o.altKey||o.button>1,c=r?()=>{}:()=>{t.location=a};r||o.preventDefault(),e.setTimeout(c,1e3),n("event","click",{event_category:"outbound",event_label:a,transport_type:"beacon",event_callback:c})}));const c=e=>{try{return JSON.parse(atob(e.split(".")[1]))}catch(t){return{}}};if(null!==t.querySelector(".online-meeting")){const o=e.DailyIframe.wrap(t.getElementById("daily-call-frame")),a=new URLSearchParams(t.location.search),r=a.get("t"),s=r?c(r):{},i=s.r||a.get("r")||"meeting",l={room:i,token:r,tokenData:s},u=e=>{n("event","meeting",{event_category:e.action,event_label:JSON.stringify({...l,event:e})})},v={url:`https://zopatista.daily.co/${i}`,showFullscreenButton:!0,showLeaveButton:!0};r&&(v.token=r),o.join(v),o.on("joining-meeting",u).on("joined-meeting",u).on("participant-joined",u).on("participant-updated",u).on("participant-left",u).on("network-quality-change",u).on("left-meeting",e=>{n("event","meeting",{event_category:"left-meeting",event_label:JSON.stringify({...l,event:e,participants:o.participants()}),event_callback:()=>{t.location="/"}})}).on("error",e=>{n("event","exception",{description:JSON.stringify({...l,error:e}),fatal:!1})})}})})(window,document);
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
