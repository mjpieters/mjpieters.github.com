 ...
 * All rights reserved
 */
((e,t,a)=>{const n="6LfT7JoUAAAAAOJeXkJp-_YhnKEvnz3DhEM-ni2n",o=12e4,s=[new RegExp("\\b(?:"+["stackoverflow\\.com","stackoverflow","stack\\s+overflow","on\\s+stack","deleted","my\\s+(?:answer|question|comment|post|response)s?","reputations?","upvotes","reconsider\\s+your\\s+actions","review\\s+(?:my\\s+)?ban","who\\s+do\\s+you\\s+think\\s+you\\s+are"].join("|")+")\\b","ig"),new RegExp("\\b(?:"+["on\\s+SO"].join("|")+")\\b","g")],c=[new RegExp("\\b(?:"+["for\\s+freelance\\s+work","(?:you\\s+)?are\\s+available","be\\s+available","(?:your\\s+)?hourly\\s+rate","interview\\s+you","python\\s+training","partnering\\s+with"].join("|")+")\\b","ig")],r=2,l=(e,t)=>t.reduce((t,a)=>t+(e.match(a)||[]).length,0),i=(e,a)=>{let n=null;return(...o)=>{const s=()=>e(...o);t.clearTimeout(n),n=t.setTimeout(s,a)}};e(()=>{const v=t.gtag||((e,t,a)=>{console.log("gtag()",e,t,a),"event"===e&&"event_callback"in a&&a.event_callback()});if(e(".contactForm").length){const p=e(".contactForm"),u=p.find("#captchaResponse"),f=p.find(":submit"),m=p.find("#contact_name"),g=p.find("#contact_email"),d=p.find("#contact_message"),_=p.find("#stackoverflow_feedback"),b=p.find("#contact_soscore");let h=!1;const y=e=>{grecaptcha.ready(()=>{grecaptcha.execute(n,{action:e}).then(e=>u.val(e))})};y("contactform_load"),t.setInterval(y,.9*o,"contactform_token_refresh"),d.on("input",i(()=>{const e=d.val(),t=l(e,s)-l(e,c);b.val(t),t<r?(h&&(_.stop(!0,!0).slideUp("fast"),v("event","so_feedback_hidden",{event_category:"contact",event_label:[m.val(),g.val(),e].join("|"),value:t})),h=!1):(h||(_.stop(!0,!0).slideDown("fast"),v("event","so_feedback_shown",{event_category:"contact",event_label:[m.val(),g.val(),e].join("|"),value:t})),h=!0)},400)),p.on("input","input,textarea",e=>f.prop("disabled",!e.delegateTarget.checkValidity())),p.find("input[maxlength],textarea[maxlength]").on("input",t=>{const a=e(t.target),n=parseInt(a.attr("maxlength"),10);if(isNaN(n))return void a.off(t);const o=a.val().length;let s=a.prev(".message-count");o<n/2?s.length&&s.remove():(s.length||(s=e(`\n            <span class="message-count">\n              <span class="counter">${o}</span>/<span class="maxlength">${n}</span>\n            </span>\n          `).insertBefore(a)),s.find(".counter").text(o),s.toggleClass("near-limit",o>.9*n))}),p.submit(n=>{n.preventDefault();const o=p.attr("action"),s=g.val()||"<no email set>",c=p.data("success"),r=p.data("error"),l=e(p.data("error-text")),i=e.magnificPopup.instance;v("event","submit",{event_category:"contact",event_label:s,value:parseInt(b.val())}),e.ajax({type:"POST",dataType:"json",url:o,data:p.serialize()}).done(e=>{let n,o=null,p=!1,u="successful";i.close(),"success"===e.status?(n=c,o=(()=>{p||(p=!0,t.setTimeout(o,100)),a.location="/"})):(u="error",n=r,o=(()=>{p||(p=!0,t.setTimeout(o,100)),y("contactform_error_retry")}),l.text(e.message),v("event","exception",{description:`Contact form submission error: ${JSON.stringify(e)}`,fatal:!1})),v("event",u,{event_category:"contact",event_label:s,value:parseInt(b.val()),event_callback:()=>{p=!0}}),i.open({type:"inline",items:{src:n},callbacks:{close:o}},0)}).fail((e,a,n)=>{var o,c,p=!1;e.readyState<2?o="Failed to contact the form server (network error)":(o=`(${e.status}) ${a} ${n}`,e.responseText&&(o=`<p>${o}</p><p>${e.responseText}</p>`)),i.close(),v("event","fail",{event_category:"contact",event_label:s,event_callback:()=>{p=!0}}),v("event","exception",{description:`Contact form submission failure: ${o}`,fatal:!0}),c=(()=>{p||(p=!0,t.setTimeout(c,100)),y("contactform_error_retry")}),l.html(o),i.open({type:"inline",items:{src:r},callbacks:{close:c}},0)})})}const p=a.location.hostname;e("a[href]").filter((e,t)=>t.hostname!==p).click(n=>{const o=e(n.target).attr("href"),s="_blank"===e(n.target).attr("target")||n.metaKey||n.ctrlKey||n.shiftKey||n.altKey||n.which>1,c=s?()=>{}:()=>{a.location=o};s||n.preventDefault(),t.setTimeout(c,1e3),v("event","click",{event_category:"outbound",event_label:o,transport_type:"beacon",event_callback:c})})})})(window.jQuery,window,document);
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
