 ...
 * All rights reserved
 */
((e,t,n)=>{const a="6LfT7JoUAAAAAOJeXkJp-_YhnKEvnz3DhEM-ni2n",o=12e4,s=[new RegExp("\\b(?:"+["stackoverflow\\.com","stackoverflow","stack\\s+overflow","on\\s+stack","deleted","my\\s+(?:answer|question|comment|post|response)s?","reputations?","upvotes","reconsider\\s+your\\s+actions","review\\s+(?:my\\s+)?ban","who\\s+do\\s+you\\s+think\\s+you\\s+are"].join("|")+")\\b","ig"),new RegExp("\\b(?:"+["on\\s+SO"].join("|")+")\\b","g")],c=[new RegExp("\\b(?:"+["for\\s+freelance\\s+work","(?:you\\s+)?are\\s+available","be\\s+available","(?:your\\s+)?hourly\\s+rate","interview\\s+you","python\\s+training","partnering\\s+with"].join("|")+")\\b","ig")],r=2,l=(e,t)=>t.reduce((t,n)=>t+(e.match(n)||[]).length,0),i=(e,n)=>{let a=null;return(...o)=>{const s=()=>e(...o);t.clearTimeout(a),a=t.setTimeout(s,n)}};e(()=>{const p=t.gtag||((e,t,n)=>{console.log("gtag()",e,t,n),"event"===e&&"event_callback"in n&&n.event_callback()}),v=t.onerror;if(t.onerror=function(e,t,n,a,o){"undefined"!=typeof StackTrace&&StackTrace.fromError(o).then(o=>{const s={msg:e,file:t,line:n,col:a,stack:o};p("event","exception",{description:JSON.stringify(s),fatal:!0})})["catch"](()=>{try{p("event","exception",{description:`Failure to create stacktrace; ${t}:${n}:${a} ${e} (${o})`,fatal:!0})}catch(s){console.log("Giving up on all error handling, bailing out",s,[e,t,n,a,o])}}),"function"==typeof v&&v(e,t,n,a,o)},e(".contactForm").length){const v=e(".contactForm"),u=v.find("#captchaResponse"),f=v.find(":submit"),g=v.find("#contact_name"),m=v.find("#contact_email"),d=v.find("#contact_message"),h=v.find("#stackoverflow_feedback"),b=v.find("#contact_soscore");let y=!1;const _=e=>{grecaptcha.ready(()=>{grecaptcha.execute(a,{action:e}).then(e=>u.val(e))})};_("contactform_load"),t.setInterval(_,.9*o,"contactform_token_refresh"),d.on("input",i(()=>{const e=d.val(),t=l(e,s)-l(e,c);b.val(t),t<r?(y&&(h.stop(!0,!0).slideUp("fast"),p("event","so_feedback_hidden",{event_category:"contact",event_label:[g.val(),m.val(),e].join("|"),value:t})),y=!1):(y||(h.stop(!0,!0).slideDown("fast"),p("event","so_feedback_shown",{event_category:"contact",event_label:[g.val(),m.val(),e].join("|"),value:t})),y=!0)},400)),v.on("input","input,textarea",e=>f.prop("disabled",!e.delegateTarget.checkValidity())),v.find("input[maxlength],textarea[maxlength]").on("input",t=>{const n=e(t.target),a=parseInt(n.attr("maxlength"),10);if(isNaN(a))return void n.off(t);const o=n.val().length;let s=n.prev(".message-count");o<a/2?s.length&&s.remove():(s.length||(s=e(`\n            <span class="message-count">\n              <span class="counter">${o}</span>/<span class="maxlength">${a}</span>\n            </span>\n          `).insertBefore(n)),s.find(".counter").text(o),s.toggleClass("near-limit",o>.9*a))}),v.submit(a=>{a.preventDefault();const o=v.attr("action"),s=m.val()||"<no email set>",c=v.data("success"),r=v.data("error"),l=e(v.data("error-text")),i=e.magnificPopup.instance;p("event","submit",{event_category:"contact",event_label:s,value:parseInt(b.val())}),e.ajax({type:"POST",dataType:"json",url:o,data:v.serialize()}).done(e=>{let a,o=null,v=!1,u="successful";i.close(),"success"===e.status?(a=c,o=(()=>{v||(v=!0,t.setTimeout(o,100)),n.location="/"})):(u="error",a=r,o=(()=>{v||(v=!0,t.setTimeout(o,100)),_("contactform_error_retry")}),l.text(e.message),p("event","exception",{description:`Contact form submission error: ${JSON.stringify(e)}`,fatal:!1})),p("event",u,{event_category:"contact",event_label:s,value:parseInt(b.val()),event_callback:()=>{v=!0}}),i.open({type:"inline",items:{src:a},callbacks:{close:o}},0)}).fail((e,n,a)=>{var o,c,v=!1;e.readyState<2?o="Failed to contact the form server (network error)":(o=`(${e.status}) ${n} ${a}`,e.responseText&&(o=`<p>${o}</p><p>${e.responseText}</p>`)),i.close(),p("event","fail",{event_category:"contact",event_label:s,event_callback:()=>{v=!0}}),p("event","exception",{description:`Contact form submission failure: ${o}`,fatal:!0}),c=(()=>{v||(v=!0,t.setTimeout(c,100)),_("contactform_error_retry")}),l.html(o),i.open({type:"inline",items:{src:r},callbacks:{close:c}},0)})})}const u=n.location.hostname;e("a[href]").filter((e,t)=>t.hostname!==u).click(a=>{const o=e(a.target).attr("href"),s="_blank"===e(a.target).attr("target")||a.metaKey||a.ctrlKey||a.shiftKey||a.altKey||a.which>1,c=s?()=>{}:()=>{n.location=o};s||a.preventDefault(),t.setTimeout(c,1e3),p("event","click",{event_category:"outbound",event_label:o,transport_type:"beacon",event_callback:c})})})})(window.jQuery,window,document);
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
