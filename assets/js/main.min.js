 ...
 * All rights reserved
 */
((e,t,n)=>{const a="6LfT7JoUAAAAAOJeXkJp-_YhnKEvnz3DhEM-ni2n",o=12e4,r=[new RegExp("\\b(?:"+["stackoverflow\\.com","stackoverflow","stack\\s+overflow","on\\s+stack","deleted","my\\s+(?:answer|question|comment|post|response)s?","reputations?","upvotes","reconsider\\s+your\\s+actions","review\\s+(?:my\\s+)?ban","who\\s+do\\s+you\\s+think\\s+you\\s+are"].join("|")+")\\b","ig"),new RegExp("\\b(?:"+["on\\s+SO"].join("|")+")\\b","g")],c=[new RegExp("\\b(?:"+["for\\s+freelance\\s+work","(?:you\\s+)?are\\s+available","be\\s+available","(?:your\\s+)?hourly\\s+rate","interview\\s+you","python\\s+training","partnering\\s+with"].join("|")+")\\b","ig")],s=2,i=(e,t)=>t.reduce((t,n)=>t+(e.match(n)||[]).length,0),l=(e,n)=>{let a=null;return(...o)=>{const r=()=>e(...o);t.clearTimeout(a),a=t.setTimeout(r,n)}};e(()=>{const p=t.gtag||((e,t,n)=>{console.log("gtag()",e,t,n),"event"===e&&"event_callback"in n&&n.event_callback()}),v=t.onerror;if(t.onerror=function(e,t,n,a,o){"undefined"!=typeof StackTrace&&StackTrace.fromError(o).then(o=>{const r={msg:e,file:t,line:n,col:a,stack:o};p("event","exception",{description:JSON.stringify(r),fatal:!0})})["catch"](()=>{try{p("event","exception",{description:`Failure to create stacktrace; ${t}:${n}:${a} ${e} (${o})`,fatal:!0})}catch(r){console.log("Giving up on all error handling, bailing out",r,[e,t,n,a,o])}}),"function"==typeof v&&v(e,t,n,a,o)},e(".contactForm").length){const v=e(".contactForm"),g=v.find("#captchaResponse"),u=v.find(":submit"),f=v.find("#contact_name"),m=v.find("#contact_email"),d=v.find("#contact_message"),y=v.find("#stackoverflow_feedback"),h=v.find("#contact_soscore");let _=!1;const b=e=>{grecaptcha.ready(()=>{grecaptcha.execute(a,{action:e}).then(e=>g.val(e))})};b("contactform_load"),t.setInterval(b,.9*o,"contactform_token_refresh"),d.on("input",l(()=>{const e=d.val(),t=i(e,r)-i(e,c);h.val(t),t<s?(_&&(y.stop(!0,!0).slideUp("fast"),p("event","so_feedback_hidden",{event_category:"contact",event_label:[f.val(),m.val(),e].join("|"),value:t})),_=!1):(_||(y.stop(!0,!0).slideDown("fast"),p("event","so_feedback_shown",{event_category:"contact",event_label:[f.val(),m.val(),e].join("|"),value:t})),_=!0)},400)),v.on("input","input,textarea",e=>u.prop("disabled",!e.delegateTarget.checkValidity())),v.find("input[maxlength],textarea[maxlength]").on("input",t=>{const n=e(t.target),a=parseInt(n.attr("maxlength"),10);if(isNaN(a))return void n.off(t);const o=n.val().length;let r=n.prev(".message-count");o<a/2?r.length&&r.remove():(r.length||(r=e(`\n            <span class="message-count">\n              <span class="counter">${o}</span>/<span class="maxlength">${a}</span>\n            </span>\n          `).insertBefore(n)),r.find(".counter").text(o),r.toggleClass("near-limit",o>.9*a))}),v.submit(a=>{a.preventDefault();const o=v.attr("action"),r=m.val()||"<no email set>",c=v.data("success"),s=v.data("error"),i=e(v.data("error-text")),l=e.magnificPopup.instance;p("event","submit",{event_category:"contact",event_label:r,value:parseInt(h.val())}),e.ajax({type:"POST",dataType:"json",url:o,data:v.serialize()}).done(e=>{let a,o=null,v=!1,g="successful";l.close(),"success"===e.status?(a=c,o=(()=>{v||(v=!0,t.setTimeout(o,100)),n.location="/"})):(g="error",a=s,o=(()=>{v||(v=!0,t.setTimeout(o,100)),b("contactform_error_retry")}),i.text(e.message),p("event","exception",{description:`Contact form submission error: ${JSON.stringify(e)}`,fatal:!1})),p("event",g,{event_category:"contact",event_label:r,value:parseInt(h.val()),event_callback:()=>{v=!0}}),l.open({type:"inline",items:{src:a},callbacks:{close:o}},0)}).fail((e,n,a)=>{var o,c,v=!1;e.readyState<2?o="Failed to contact the form server (network error)":(o=`(${e.status}) ${n} ${a}`,e.responseText&&(o=`<p>${o}</p><p>${e.responseText}</p>`)),l.close(),p("event","fail",{event_category:"contact",event_label:r,event_callback:()=>{v=!0}}),p("event","exception",{description:`Contact form submission failure: ${o}`,fatal:!0}),c=(()=>{v||(v=!0,t.setTimeout(c,100)),b("contactform_error_retry")}),i.html(o),l.open({type:"inline",items:{src:s},callbacks:{close:c}},0)})})}const g=n.location.hostname;e("a[href]").filter((e,t)=>t.hostname!==g).click(a=>{const o=e(a.target).attr("href"),r="_blank"===e(a.target).attr("target")||a.metaKey||a.ctrlKey||a.shiftKey||a.altKey||a.which>1,c=r?()=>{}:()=>{n.location=o};r||a.preventDefault(),t.setTimeout(c,1e3),p("event","click",{event_category:"outbound",event_label:o,transport_type:"beacon",event_callback:c})});const u=e=>{try{return JSON.parse(t.atob(e.split(".")[1]))}catch(n){return{}}};if(e(".online-meeting").length){const e=t.DailyIframe.wrap(n.getElementById("daily-call-frame")),a=new URL(n.location).searchParams,o=a.get("t"),r=o?u(o):{},c=r.r||a.get("r")||"meeting",s={room:c,token:o,tokenData:r},i=e=>{p("event","meeting",{event_category:e.action,event_label:JSON.stringify({...s,event:e})})},l={url:`https://zopatista.daily.co/${c}`,showFullscreenButton:!0,showLeaveButton:!0};o&&(l.token=o),e.join(l),e.on("joining-meeting",i).on("joined-meeting",i).on("participant-joined",i).on("participant-updated",i).on("participant-left",i).on("network-quality-change",i).on("left-meeting",t=>{p("event","meeting",{event_category:"left-meeting",event_label:JSON.stringify({...s,event:t,participants:e.participants()}),event_callback:()=>{n.location="/"}})}).on("error",e=>{p("event","exception",{description:JSON.stringify({...s,error:e}),fatal:!1})})}})})(window.jQuery,window,document);
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
